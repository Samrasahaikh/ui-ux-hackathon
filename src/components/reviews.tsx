...
import { FaStar, FaRegStar, FaCheckCircle, FaArrowLeft, FaArrowRight } from "react-icons/fa";
    ...
    <section className="bg-gray-50 py-10 max-w-screen-2xl m-auto">
      <div className="max-w-screen-lg mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <h1 className="font-extrabold text-2xl sm:text-3xl font-integral">OUR HAPPY CUSTOMERS</h1>
        ...
        <div
          ref={sliderRef}
          className="flex space-x-6 overflow-x-auto px-6 scrollbar-hide"
        >
