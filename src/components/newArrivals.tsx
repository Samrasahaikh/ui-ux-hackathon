...
const ProductBox = ({ product }: { product: Product }) => {
  ...
  return (
    <div
      className="w-full sm:w-[48%] md:w-[22%] flex flex-col items-center"
    ...
    >
      ...
      <h1 className="font-bold font-sans pt-2 text-sm sm:text-md ">{product.title}</h1>
  ...
  product.oldPrice && (
    <>
      ...
      <div className="flex items-center space-x-1 text-yellow-400 text-md pt-1">
        ...
        <p className="text-gray-400 text-sm pt-1 font-bold">{product.rating}/5</p>
      </div>
    </div>
  );
};
